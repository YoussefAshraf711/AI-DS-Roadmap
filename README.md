...
## 📜 جدول المحتويات
*   [**المرحلة 0: الأساسيات - البيئة والأدوات**](#-المرحلة-0-الأساسيات---البيئة-والأدوات)
*   [**المرحلة 1: أساسيات البرمجة والبيانات**](#-المرحلة-1-أساسيات-البرمجة-والبيانات)
*   [**المرحلة 2: الركيزة الرياضية**](#-المرحلة-2-الركيزة-الرياضية)
*   [**المرحلة 3: تعلم الآلة الكلاسيكي**](#-المرحلة-3-تعلم-الآلة-الكلاسيكي)
*   [**المرحلة 4: التعلم العميق والمعماريات الحديثة**](#-المرحلة-4-التعلم-العميق-والمعماريات-الحديثة)
*   [**المرحلة 5: هندسة الذكاء الاصطناعي ونشر النماذج**](#-المرحلة-5-هندسة-الذكاء-الاصطناعي-ونشر-النماذج)
*   [**المرحلة 6: MLOps ودورة حياة الإنتاج**](#-المرحلة-6-mlops-ودورة-حياة-الإنتاج)
*   [**المرحلة 7: تقنيات البيانات الضخمة**](#-المرحلة-7-تقنيات-البيانات-الضخمة)
*   [**المرحلة 8: التخصصات المتقدمة (اختر مسارك)**](#-المرحلة-8-التخصصات-المتقدمة-اختر-مسارك)
*   [**المرحلة 9: البحث ومواكبة التطورات**](#-المرحلة-9-البحث-ومواكبة-التطورات)
*   [**بناء معرض أعمالك الاحترافي**](#-بناء-معرض-أعمالك-الاحترافي)
